...
router.get('/payments/budget', [PaymentsController, 'getBudget']).use(middleware.auth())
...
router.post('/transactions/create-beneficiaire', [TransactionsController, 'createVirementBeneficiaire']).use(middleware.auth())
router.get('/beneficiaires', [BeneficiairesController, 'getMyBeneficiaires']).use(middleware.auth())
router.post('/beneficiaires/create', [BeneficiairesController, 'createBeneficiaire']).use(middleware.auth())
router.delete('/beneficiaires/:id', [BeneficiairesController, 'deleteBeneficiaire']).use(middleware.auth())
